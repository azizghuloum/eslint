        ...
        const baseOffsetListeners = {
            ...
            ConditionalExpression(node) {
                ...
                if (!options.flatTernaryExpressions ||
                    ...
                    offsets.setDesiredOffset(questionMarkToken, firstToken, options.offsetTernaryExpressions ? 1 : 0);
                    offsets.setDesiredOffset(colonToken, firstToken, options.offsetTernaryExpressions ? 1 : 0);
